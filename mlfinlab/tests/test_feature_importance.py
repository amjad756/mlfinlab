...
class TestFeatureImportance(unittest.TestCase):
    ...
    def test_feature_importance(self):
        ...
        # Value in the below test was changed after from -6.39442
        #                                            to  -6.63980
        # Value in the below test was changed after from -5.04315
        #                                            to  -5.21891
        self.assertAlmostEqual(sfi_feat_imp_log_loss.loc['I_0', 'mean'], -6.63980, delta=0.1)
        self.assertAlmostEqual(sfi_feat_imp_log_loss.loc['R_0', 'mean'], -5.21891, delta=0.1)
        ...
        #                                                     to  0.03382
        # due to scikit-learn changing RandomForestClassifier, and BaggingClassifier outputs
        # Value in the below test was changed after v.0.11.3 from 0.02940
        #                                                     to -0.08060
        self.assertAlmostEqual(clustered_mda.loc['I_0', 'mean'], 0.03382, delta=0.1)
        self.assertAlmostEqual(clustered_mda.loc['R_0', 'mean'], -0.08060, delta=0.1)
